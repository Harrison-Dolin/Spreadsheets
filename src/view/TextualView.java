...
public class TextualView implements View {
  ...
  public void addFeatures(Features features) {
    ...
    // enables the creation of the EditingView, and in the EditingView it allows for controller
    // interaction. However, in the TextualView there is no need for features.
  }

  @Override
  public void acceptMouseListener(MouseListener m) {
    // This method needs to be empty because it is necessary in the interface for views, and
    // enables the creation of the EditingView. However, in the TextualView there is no need for
    // a mouselistener.
  }
