...
/**
 * Represents an unmodifiable spreadsheet view that incorporates a grid of cells populated by a
 * given read-only Spreadsheet model and has a set of JButtons that allows infinite user traversal
 * of the grid.
 */
public class VisualPanel extends JPanel implements ActionListener {
  ...
  /**
   * Creates a JPanel with a set of JButtons that change the offsets of the view. Allows the
   * user to move up down, left and right.
   */
